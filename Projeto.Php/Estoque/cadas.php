...
<form action="cadastro.php" method="POST" class="center-form">
    ...
    <input type="number" name="id_Local" id="id_Local" class="form-control" required>
    <br>
...
<form action="delet.php" method="post" class="delete-form">
    <label for="id_Local">Digite o ID que deseja excluir:</label>
    <input type="text" name="id_Local" id="id_Local" placeholder="Excluir" required>
...
// Consulta ajustada com a nova tabela 'local_destino'
